...
int main(int argc, char* argv[]){
	...
	for(int ii=0; ii<30; ii++){
		...
		ArithmeticMeanStrategy arith_strat_test = {};
		calculations::Calculations::set_expected_return_strategy(&arith_strat_test);
		std::cout << "Arithmetic Strategy: " << calculations::Calculations::get_expected_return(portfolio_returns)<<std::endl;

		DiscountedMeanStrategy discnt_strat_test(2);
		calculations::Calculations::set_expected_return_strategy(&discnt_strat_test);
		std::cout << "Discounted Strategy: " << calculations::Calculations::get_expected_return(portfolio_returns)<<std::endl;
	}
}
